...
Unfortunately, these translated to some really ugly MarkDown blocks like:
...
that weren't code blocks at all. The places where I just used bare `<pre>`
blocks translated fine.
