...
## Machine & Online Update Problems.

First, I lost two machines. About a month ago, my main
...
While I was working on VPN
stuff, Joe took it upon himself to forcibly commandeer one of my spare
boxes and setup
[Trixbox](http://www.trixbox.org/) (formerly Asterisk @ Home) on the LAN. At the moment, we're
...
A lot of stuff on the rack has serial console access - switches, IPcop, routers, development
